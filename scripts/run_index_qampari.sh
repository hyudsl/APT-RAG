...
readonly CORPUS="$APT_ROOT/data/artifacts/corpus/qampari/corpus.jsonl"
readonly MODEL_NAME="Qwen/Qwen3-Embedding-0.6B"
readonly OUTPUT_DIR_MAIN="$APT_ROOT/data/artifacts/vectorDB/qampari"
...
if [[ "${SMOKE}" == "1" ]]; then
  UNIT_NAME="indexing-qampari-smoke"
