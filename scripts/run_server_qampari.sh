...
readonly UNIT_NAME="vectorstore-qampari"
...
if [[ ! -d "${VECTORDB_PATH}" ]]; then
  ...
  echo "        Run run_index_qampari.sh first to build the index." >&2
  exit 1
fi
